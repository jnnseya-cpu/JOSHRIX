...
<div style="max-width:560px;margin:0 auto;padding:28px 20px">
  <table role="presentation" style="width:100%"><tr>
    <td style="width:42px"><div style="width:34px;height:34px;background:linear-gradient(135deg,#E4813C,#E4813C);border-radius:8px;text-align:center;line-height:34px;font-weight:800;color:#fff">JX</div></td>
    <td style="font-weight:800;letter-spacing:.08em">JOSHRIX <span style="color:#E4813C">STUDIO</span></td>
  </tr></table>
  <div style="height:3px;background:linear-gradient(90deg,#E4813C,#E4813C);border-radius:2px;margin:16px 0 22px"></div>
  ...
  <a href="https://www.joshrix.com/dashboard.html" style="display:inline-block;background:linear-gradient(135deg,#E4813C,#E4813C);color:#fff;text-decoration:none;font-weight:700;padding:11px 22px;border-radius:10px">Open JOSHRIX</a>
...
export function renderNewsletter(opts: {
  ...
  <h2 style="font-size:13px;letter-spacing:.14em;text-transform:uppercase;color:#E4813C;margin:30px 0 8px">${esc(s.heading)}</h2>
...
<div style="max-width:600px;margin:0 auto;padding:28px 20px">
  ...
  <a href="${esc(tag("/studio"))}" style="display:inline-block;background:linear-gradient(135deg,#E4813C,#E4813C);color:#fff;text-decoration:none;font-weight:700;padding:11px 22px;border-radius:10px">Open the Studio</a>
  ${sections}
