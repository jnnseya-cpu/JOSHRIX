...
LIBRARY 4 — QUATERNIUS CC0 CHARACTERS AND CREATURES, 318 models in 11 packs, 259 of them carrying full skeletal animation. Base URL: https://www.joshrix.com/assets/models3d/packs/<pack>/<name>.glb — e.g. .../packs/quaternius-characters/ninja_female.glb
...
- quaternius-fbx (156, 103 animated) TWO RULES OF ITS OWN — read both before using it, they are the opposite of every pack above.
  RULE 1 — clip names in THIS pack are lowercase: "idle" "walk" "run" "attack" "die" "jump" "swim" "fly", NOT "Idle"/"Walk"/"Death". Using the capitalised names above leaves the character frozen.
  RULE 2 — every model here is normalised to 1.85 units tall whatever it is, so an avocado stands as tall as a horse. ALWAYS pass a height (or size, for flat things like a dock) to G.load. A raw load from this pack is the one reliable way to make a world look wrong.
  · sea life (40, all animated) — the ONLY underwater cast in the library, so any ocean, reef, aquarium or fishing concept starts here: anglerfish armored_catfish betta black_lion_fish blobfish blue_goldfish blue_tang butterfly_fish cardinal_fish clownfish coral_grouper cowfish dolphin fish fish1 fish2 fish3 flatfish flower_horn goldfish humphead koi lionfish mandarin_fish manta_ray moorish_idol piranha puffer red_snapper royal_gramma shark sunfish swordfish tang tetra tuna turbot whale yellow_tang zebra_clown_fish · clips: swim attack die out_of_water
  · dinosaurs (6, all animated) — also the only ones in the library: apatosaurus parasaurolophus stegosaurus trex triceratops velociraptor · clips: idle walk run jump attack die
  · land animals and birds (17, all animated): bat bird cat chick cow dog eagle frog horse llama parrot_fish pig pug red_fox sheep wolf zebra · clips: idle walk run jump fly swim attack die
  · enemies and monsters (15, 14 animated): alien alien_helmet dragon goblin goblin_shark rat robot skeleton snake snake_angry spider wasp worm zombie zombie_smooth · clips: idle walk run jump fly crawl swim attack die
  · people (48, 20 animated) — the animated ones are animated_human animated_woman animated_woman_smooth knight_character and the male_*/female_* set; the *_hairstyle_* and smooth_* entries are static wearables and variants: animated_human animated_woman animated_woman_smooth knight_character female_alternative female_casual female_dress female_looking_up female_picking_up female_running female_sitting female_sitting_cheering female_standing female_standing_covering_eyes female_standing_hips female_tank_top female_walking male_casual male_long_sleeve male_looking_up male_picking_up male_running male_shirt male_sitting male_sitting_cheering male_standing male_standing_covering_eyes male_standing_hips male_standing_waving male_suit male_walking woman_standing_waving smooth_female_alternative smooth_female_casual smooth_female_dress smooth_female_tank_top smooth_male_casual smooth_male_long_sleeve smooth_male_shirt smooth_male_suit female_hairstyle_1 female_hairstyle_2 female_hairstyle_3 female_hairstyle_4 male_hairstyle_1 male_hairstyle_2 male_hairstyle_3 male_hairstyle_4 · clips: idle walk run jump sit pickup attack die
  · docks boats and fishing gear (16, static): boat dock_long dock_long_no_rope dock_stairs dock_wide fishing_rod_lvl1 fishing_rod_lvl2 fishing_rod_lvl3 fishing_rod_lvl4 fishing_rod_lvl5 lure_1 lure_2 lure_3 lure_4 lure_5 lure_6
  · weapons armour and food (14): sword short_sword katana club helmet1 helmet2 helmet3 shoulder_pads avocado avocado_flatshaded banana peach watermelon pineapple
