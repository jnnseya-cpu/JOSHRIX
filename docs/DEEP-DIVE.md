...
**Where they bleed:** creators keep roughly 24–29% effectively (DevEx ≈ $0.0038/Robux after the 30% marketplace fee and platform share); creators own **no IP** — everything lives and dies inside the walled garden; fidelity is dated; the audience skews young; and their moat is also their prison — they **cannot** offer IP ownership or web-portable games without dismantling their own economics. Note the trend: Roblox introduced a **US 18+ DevEx rate paying 42% more** on adult spend — they feel the payout-share pressure and will keep raising percentages. That is exactly why our wedge must never be *share alone*: they can match a number; they can never match ownership, portability, and exit.
...
**What they truly own:** first-mover "prompt-to-game" mindshare; fast toy demos; low friction. Rosebud is the reference tool (browser prompt-to-playable in minutes, the consensus pick for prototypes/jams/classrooms) and now markets **monetisation at 0% commission** — tipping plus "publish anywhere, keep 100%." Bitmagic remains waitlist-gated (an open-access opportunity for us); Upit optimises for quick sharing.
**Where they bleed:** output is disposable — no QA bar, no marketplace demand, no IP registry, no store-export pipeline, no post-launch life. They ship *demos*. Nobody has built the **commercial operating system** around generation.
**Our gap:** they shipped generation earlier, hold the "AI game maker" search mindshare, and Rosebud's 0% beats our 20% *as a headline*.
**The close — beware the 0% trap:** 100% of tips on a self-hosted toy is less than 80% of certified commerce. A percentage without demand is theatre; creators don't eat percentages, they eat payouts. Our answer is the whole rail 0% platforms don't have: a marketplace with actual buyers (including B2B white-label demand), QA certification that makes titles saleable, IP certificates that make them ownable, store export that makes them installable, and LiveOps that keeps them alive. Publish the comparison in pounds, not percentages: *average creator earnings per published title*, ours vs theirs. That is the number 0% platforms cannot survive. And never drift into their toy-demo framing: we don't demo games appearing — we demo **businesses** appearing.
