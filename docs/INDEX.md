...
| 5 | Core AI Agents (production + governance + operational) | [PLATFORM.md](PLATFORM.md) — seven-agent Production Fleet with inputs/outputs/triggers/APIs/business value; Governance Fleet; [INTELLIGENCE.md](INTELLIGENCE.md) — self-managing platform fleet (Bug Detection, Auto-Repair, Infrastructure Optimisation, Release Management, AI Governance) |
